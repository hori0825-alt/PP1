...
export const eggplantBodySections: BodySection[] = [
  ...
  { t: 0.2, z: 8.4, rx: 16.5, ry: 14.9, cx: 0, cy: 0.3, n: 2.0 },
  { t: 0.3, z: 12.6, rx: 17.8, ry: 16.1, cx: 0, cy: 0.4, n: 2.0 },
  { t: 0.4, z: 16.8, rx: 18.5, ry: 16.7, cx: 0, cy: 0.45, n: 2.0 },
  { t: 0.5, z: 21.0, rx: 18.6, ry: 16.8, cx: 0, cy: 0.5, n: 2.0 }, // 最大幅付近
  { t: 0.6, z: 25.2, rx: 18.5, ry: 16.7, cx: 0, cy: 0.45, n: 2.0 },
  { t: 0.7, z: 29.4, rx: 18.0, ry: 16.3, cx: 0, cy: 0.4, n: 2.0 },
  { t: 0.8, z: 33.6, rx: 17.2, ry: 15.5, cx: 0, cy: 0.3, n: 2.02 },
  { t: 0.9, z: 37.8, rx: 16.2, ry: 14.7, cx: 0, cy: 0.15, n: 2.05 },
  { t: 1.0, z: 42.0, rx: 13.4, ry: 12.1, cx: 0, cy: 0, n: 2.1 }, // 上端（ヘタが載る面。ほぼ絞らない）
];
